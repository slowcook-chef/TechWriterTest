...
public:
	...
	void SetUpNotifications(EOS_HAchievements* achievementHandle, EOS_HPlatform* platformHandle, EOS_ProductUserId* puid);
	~AchievementInterface();
private:
	...
	static void EOS_CALL EOS_Achievements_OnAchievementsUnlockedCallbackV2(const EOS_Achievements_OnAchievementsUnlockedCallbackV2Info* Data);
	...
	static bool bNotificationsSetup;
};